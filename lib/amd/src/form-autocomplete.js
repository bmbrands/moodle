...
define(
    ['jquery', 'core/log', 'core/str', 'core/templates', 'core/notification', 'core/loadingicon', 'core/aria', 'core/popper'],
function($, log, str, templates, notification, LoadingIcon, Aria, Popper) {
