...
class profilefield_social_testcase extends provider_testcase {
    ...
    public function test_export_user_data() {
        ...
        $this->add_user_info_data($user->id, $socialprofilefieldid, 'test social');
        ...
        $this->assertEquals('test social', $data->data);
    }
    ...
    public function test_delete_data_for_all_users_in_context() {
        ...
        $this->assertNotEquals('test social', reset($userinfodata)->data);
    }
