...
* Change scss/bootstrap/_badge.scss.

Comment out these lines because compiling the scss will break because it is not supported in the scssphp Library v. 0.7.5. For more info see: https://github.com/leafo/scssphp/issues/616.
