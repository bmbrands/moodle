...
EOD;
    ...
    public function search_box($id = false) {
        ...
        $navbarsearch->id = $id;
        $navbarsearch->placeholder = get_string('search', 'search');
        $navbarsearch->action = $CFG->wwwroot . '/search/index.php';

        return $this->render_from_template('theme_boost/navbar_search', $navbarsearch);
